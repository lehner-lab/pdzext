---
title: "figure4 Binding energies outside the binding interface"
output:
...
#plot figure4a: manhattan plots mutations
```{r}
...
print(p)
ggsave(paste0("Data_pdzext/output_pdzext/Fig_4a_",dataset_value,"_Binding.pdf"), width=15, height=5)
  }
```
#plot Figure 4b: heat maps of medians ddg&dddg&ddddg (called "energy_term")
```{r}
...
subset_dt <- merge(
  ...
  all.x = TRUE
    ...
    print(p)
ggsave(paste0("Data_pdzext/output_pdzext/Fig_4b_",dataset_value,".pdf"), width=15, height=5)
}
```
...
###############################################################################################
#plot Figure 4e: distance to extensions for mutations. Spearmann test and LOESS curves:
```{r}
library(ggplot2)
library(ggpubr)
library(data.table)
...
for (dataset_value in dataset_values) {
  ...
  if (dataset_value == "dddg_N") {
    ...
    subtitle <- "Binding - Distance to N-term"
  } else {
    xcol <- "min_disAll_ChelixAll_byResidue"
    xlab <- "3D Distance to C-helix"
    subtitle <- "Binding - Distance to C-helix"
  }
  ...
  print(p)
   ggsave(paste0("Data_pdzext/output_pdzext/Fig_4e_mutations_",dataset_value,".pdf"), width=8, height=8)
}

```

###############################################################################################
#Extended Data Figure 4 binding Spearmann test and LOESS curves:
```{r}
library(ggplot2)
library(ggpubr)
library(data.table)
...
for (dataset_value in dataset_all) {
  ...
  print(p)
  ggsave(paste0("Data_pdzext/output_pdzext/Extended_Data_Fig_4_medians_binding_",dataset_value,".pdf"), width=8, height=8)
}
